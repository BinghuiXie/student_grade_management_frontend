...
export const SELECT_LOGIN_IDENTITY: string = 'select_login_identity';
...
export const SYSTEM_TITLE: string = 'system_title';
export const SYSTEM_INTRO: string = 'system_intro';
